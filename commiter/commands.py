...
class CommitCommand:
    ...
    def _generate_commit_messages(self, max_choices: int) -> List[str]:
        ...
        try:
            ...
            with console.status("[bold blue]Generating commit message options...[/bold blue]", spinner="dots"):
...
class ConfigCommand:
    ...
    def _show_config(self):
        ...
        console.print(f"  Default Mode: Auto-commit (use --interactive for choice mode)")
    ...
    def _parse_config_update(self, key: str, value: str) -> Optional[dict]:
        ...
        if key == "interactive_mode":
            ...
            if value.lower() in ("ollama", "openai", "anthropic"):
                ...
                console.print(f"[red]Error: Invalid value for llm_provider: {value}[/red]")
            ...
            console.print("Valid keys: interactive_mode, max_choices, llm_provider, llm_model, llm_base_url")
            return None
